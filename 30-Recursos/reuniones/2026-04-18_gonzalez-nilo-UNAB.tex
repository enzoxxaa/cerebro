...
\begin{center}
    ...
    {\small Fecha: 2026-04-18 $\cdot$ Lugar: \ph{lugar} $\cdot$ Duración estimada: \ph{60 min}}
\end{center}
...
\begin{itemize}
    \item Soy \ph{Enzo Cevo — nombre completo}, \ph{título: Licenciado / Químico / MSc} de la \ph{Universidad de Chile — confirmar}, especializado en \textbf{dinámica molecular clásica (MD all-atom)} aplicada a sistemas blandos y biomoleculares.
...
\begin{itemize}
    ...
    \item \textbf{Estado:} \ph{en escritura / submitted — confirmar}. Placeholders pendientes: MET density + RDF final del thioether.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Estado:} \ph{fase: escritura — confirmar versión v4}.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Colaboración:} \ph{grupo V.\ Guixé / UChile --- confirmar PI}. Combinación de cristalografía X (sincrotrón MANACA, LNLS Brasil; 1{,}17--1{,}54~\AA) + ensayos cinéticos + MD + mutagénesis.
...
\begin{itemize}
    ...
    \item 90+ artículos ISI, 3 patentes (\ph{verificar cifra actualizada}).

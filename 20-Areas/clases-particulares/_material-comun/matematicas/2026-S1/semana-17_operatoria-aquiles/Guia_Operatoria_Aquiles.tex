...
% ────────────────────────────────────────────────────────────────────────────
% MATERIAL DEL TUTOR — PROVISIONAL.
% Se usa si el diagnóstico de la semana 16 confirma que la brecha principal
% está en operatoria. Si la brecha está en otra parte, esta guía no se usa
% y se reemplaza por el tema real.
%
% Estructura: ejercicios progresivos + cajas guía post-error (como el
% diagnóstico). La primera parte de la sesión es devolución del diagnóstico.
% ════════════════════════════════════════════════════════════════════════════
...
\fancyfoot[C]{\small\color{gray} Página \thepage\ --- \textbf{MATERIAL DEL TUTOR (PROVISIONAL)}}
...
\begin{center}
  ...
  {\itshape\color{gray}
  Material del tutor --- provisional.\\[4pt]
  Usar si el diagnóstico confirma brecha en operatoria.\\[4pt]
  Los primeros 15 min de la sesión son devolución del diagnóstico.}
\end{center}
...
\begin{enumerate}[nosep]
  \item \textbf{Devolución del diagnóstico (15 min):} decirle qué hizo bien, dónde está la brecha, y qué vamos a hacer esta semana. Tono positivo --- él necesita sentir que el plan es alcanzable.
  \item \textbf{Bloque de ejercitación (35 min):} los bloques de abajo, empezando donde indique el diagnóstico.
  \item \textbf{Cierre + tarea (10 min):} asignar solo lo que pueda hacer solo, sin frustrarse.
\end{enumerate}
\end{tcolorbox}
